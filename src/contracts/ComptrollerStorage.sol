...
contract ComptrollerV7Storage is ComptrollerV6Storage {
    /// @notice Whether an address is whitelisted for cToken transfers transfers or not.
    /// @notice Overrides transferGuardianPaused and will allow transfers to whitelisted address regardless
    mapping(address => bool) public transferAllowedWhitelist;
}
